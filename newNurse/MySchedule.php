...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_weekly_schedule'])) {
    ...
    $day_values = [
        in_array('sunday', $days) ? 'yes' : 'no',
        in_array('monday', $days) ? 'yes' : 'no',
        in_array('tuesday', $days) ? 'yes' : 'no',
        in_array('wednesday', $days) ? 'yes' : 'no',
        in_array('thursday', $days) ? 'yes' : 'no',
        in_array('friday', $days) ? 'yes' : 'no',
        in_array('saturday', $days) ? 'yes' : 'no',
        $start_time,
        $end_time,
        $nurse_id
    ];

...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    if ($action === 'reject') {
        ...
        if (!empty($reason)) {
            $update_query = "UPDATE request SET RequestStatus = 'rejected', reason = '$reason' WHERE RequestID = $request_id";
...
$query = "SELECT r.RequestID, u.FullName AS PatientName, s.Name AS ServiceName, r.Date AS RequestDate, r.RequestStatus, r.SpecialInstructions, r.MedicalCondition, r.NurseGender, r.AgeType, r.Time, r.Duration, r.NumberOfNurses, p.UserID, r.reason
          FROM request r
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge <?php 
                                        ...
                                        elseif ($row['RequestStatus'] === 'in progress') echo 'bg-primary';
                                ...
                                <td>
                                    <?php if ($row['RequestStatus'] === 'pending' || $row['RequestStatus'] === 'in progress') { ?>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p><strong>Reason for Rejection:</strong> <?php echo $row['reason'] ? htmlspecialchars($row['reason']) : 'None'; ?></p>
                                        </div>
                                        <div class="modal-footer">

...
if (isset($_GET['nurse_id']) && is_numeric($_GET['nurse_id']) && $_GET['nurse_id'] > 0) {
    ...
    if ($result_nurse->num_rows > 0) {
        ...
        $row['image_path'] = (!empty($row['image_path']) && file_exists($_SERVER['DOCUMENT_ROOT'] . '../nurse/' . $row['image_path']))
                                            ...
                                            <div class="col-md-4 mb-4">
                                                <div class="card h-100 border-start border-primary border-4" data-nurse-id="<?php echo htmlspecialchars($nurse['NurseID']); ?>">
                                                    <div class="card-body text-center">
                                                        <?php
                                                        $nurse_image = !empty($nurse['image_path']) && file_exists($_SERVER['DOCUMENT_ROOT'] . $image_base_path . $nurse['image_path'])
                                                            ? $image_base_path . $nurse['image_path']
                                                            : '../nurse/';
                                                        ?>

                                                        
                                                        <img src="<?php echo htmlspecialchars($nurse_image) . $nurse['image_path'] ; ?>" class="rounded-circle mb-3" width="100" alt="Nurse">
                    ...
                    <?php if ($selected_nurse): ?>
                        <div class="row">
                            <div class="col-md-4 text-center">
                                <img src="<?php echo htmlspecialchars($selected_nurse['image_path']); ?>" class="rounded-circle mb-3" width="150" alt="Nurse Photo">
